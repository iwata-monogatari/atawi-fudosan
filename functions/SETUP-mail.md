...
- トップページの写真相談: 固定資産税通知書の写真（1〜3枚、1枚5MB・合計10MBまで）を
  Resendのメール添付として **fudosan@fujigaoka-service.co.jp** に送ります。
  JPEG / PNG / WebP / HEIC / HEIFに対応し、画像の実データも検査します。
- 利用者がメールアドレスを入力した場合: 通知本文に「申込者メール」として明記し、
  Reply-Toにも設定します。電話だけの場合は、電話で折り返す旨を明記します。
